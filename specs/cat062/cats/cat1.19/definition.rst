...
Compound item (FX)
    ...
    **I062/380/IAS** - *Indicated Airspeed/Mach No*
        ...
        * Depends on the value of ``380/IAS/IM``.
    ...
    **I062/380/MAC** - *Mach Number*
    ...
    - unsigned quantity
    - unit: "Mach"
    - LSB = :math:`1/125` Mach :math:`\approx 8.00e-3` Mach
    - value :math:`>= 0` Mach
    - value :math:`<= 512/125` Mach
    ...
    **I062/380/BPS** - *Barometric Pressure Setting*
        ...
        **I062/380/BPS/BPS**
        ...
        - unsigned quantity
        - unit: "mb"
        - LSB = :math:`1/10` mb :math:`\approx 0.10` mb
        - value :math:`>= 0` mb
        - value :math:`<= 819/2` mb
