...
- unsigned quantity
- unit: "s"
- LSB = :math:`1/2` s :math:`\approx 0.50` s
...
*Structure*:
    ...
    **I021/074/TOMRP** - *Fractional Part of the Time of Message Reception for Position in the Ground Station*
    ...
    - unsigned quantity
    - unit: "s"
    - LSB = :math:`1/2^30` s :math:`\approx 9.31e-10` s
...
*Structure*:
    ...
    **I021/131/LAT** - *Latitude*
    ...
    - signed quantity
    - unit: "°"
    - LSB = :math:`180/2^30` ° :math:`\approx 1.68e-7` °
    - value :math:`>= -90` °
    - value :math:`<= 90` °
...
*Structure*:
    ...
    **I021/165/TAR** - *Track Angle Rate*
    ...
    - signed quantity
    - unit: "°/s"
    - LSB = :math:`1/2^5` °/s :math:`\approx 3.12e-2` °/s
    - value :math:`>= -16` °/s
    - value :math:`<= 16` °/s
...
Compound item (FX)
    ...
    **I021/295/AOS** - *Aircraft Operational Status Age*
    ...
    - unsigned quantity
    - unit: "s"
    - LSB = :math:`1/10` s :math:`\approx 0.10` s
    - value :math:`<= 51/2` s
