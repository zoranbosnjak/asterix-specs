#!/usr/bin/env wish
#
# Convert text description to syntax bubble diagram.
# usage: ./this_script < input.tcl > output.ps
#
# This script is a simplified version of the example, described here:
...
proc draw_graph {spec} {
  ...
  return [.c postscript -width [expr {$x1+2}] -height [expr {$y1+2}]]
}
